...
| Canonical documentation | Updated `docs/architecture/elastic-runners.md`; after the implementation push, GitHub's authenticated GFM renderer emitted all three diagrams as Mermaid enrichment blocks and preserved the outcome and final-review sections | Documentation and render review |
