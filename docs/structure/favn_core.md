...
Manifest schema 12 and runner contract 12 are the only supported versions.
...
records, up to 16 ordered row-count claims, and typed
`%Favn.SQL.Contract.Param{}` requirements. Templates reserve
