defmodule Favn.TargetGenerationRelation do
  @moduledoc """
  Deterministic physical relation names for target generations.

  This core contract is shared by planning and SQL adapters so an immutable
  rebuild plan names exactly the relation that the runner later validates.
  """
