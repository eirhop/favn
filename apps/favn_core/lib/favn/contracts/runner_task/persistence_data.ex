defmodule Favn.Contracts.RunnerTask.PersistenceData do
  ...
  @atoms [
    ...
    :refresh_timeline,
    :resource_recovery_source_run_id,
    :resource_recovery_resource,
    :resource_recovery_candidate_ids,
    :resource_kind,
    :resource_name,
