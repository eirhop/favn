...
- owns Phase 1 production runtime env validation for SQLite control-plane storage and exposes unauthenticated liveness/readiness endpoints at `/api/orchestrator/v1/health/live` and `/api/orchestrator/v1/health/ready`
