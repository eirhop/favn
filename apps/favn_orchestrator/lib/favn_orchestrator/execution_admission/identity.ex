defmodule FavnOrchestrator.ExecutionAdmission.Identity do
  ...
  @spec lease_id(String.t(), String.t()) :: String.t()
  def lease_id(run_id, asset_step_id) when is_binary(run_id) and is_binary(asset_step_id) do
    "execution_lease:" <> digest({run_id, asset_step_id})
  end
