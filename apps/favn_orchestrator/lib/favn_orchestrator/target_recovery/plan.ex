defmodule FavnOrchestrator.TargetRecovery.Plan do
  @moduledoc "Immutable, canonical target-recovery plan returned for operator approval."
  ...
  @doc "Builds a recovery plan and hashes its complete canonical payload."
  ...
  @doc "Returns the lowercase SHA-256 hash of canonical recovery-plan bytes."
