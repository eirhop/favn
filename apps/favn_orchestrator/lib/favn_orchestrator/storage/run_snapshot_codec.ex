defmodule FavnOrchestrator.Storage.RunSnapshotCodec do
  ...
  @doc false
  @spec node_key_dto(term()) :: map() | nil
  def node_key_dto(node_key), do: node_key_to_dto(node_key)
  ...
  defp manifest_runner_releases(_record), do: {:error, :invalid_manifest_runner_releases}
end
