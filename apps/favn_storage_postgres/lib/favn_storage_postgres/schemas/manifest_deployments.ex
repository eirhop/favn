defmodule FavnStoragePostgres.Schemas.ManifestDeploymentOperation do
  ...
  schema "manifest_deployment_operations" do
    ...
    field(:inspection_total, :integer, default: 0)
    field(:inspection_completed, :integer, default: 0)
    field(:accepted_at, :utc_datetime_usec)
    field(:activating_at, :utc_datetime_usec)
    field(:terminal_at, :utc_datetime_usec)
    field(:source, :string, default: "archive")
    field(:local_session_id, :string)
    field(:local_expires_at, :utc_datetime_usec)
    field(:inspection_deadline_at, :utc_datetime_usec)
    field(:cancellation_requested_at, :utc_datetime_usec)
    field(:cleanup_state, :string, default: "pending")
    field(:activation_receipt, :map)
    field(:expected_runtime_revision, :integer)
    field(:request, :map, default: %{})
    field(:inspection_binding_hash, :binary)
