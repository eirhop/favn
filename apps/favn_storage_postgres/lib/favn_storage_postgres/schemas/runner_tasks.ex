defmodule FavnStoragePostgres.Schemas.RunnerTask do
  ...
  schema "runner_tasks" do
    ...
    field(:manifest_content_hash, :string)
    field(:orchestration_context_hash, :binary)
    field(:write_claim_key, :string)
    field(:write_claim_fence, :integer)
    field(:write_target_id, :string)
    field(:write_operation_id, :string)
    field(:write_lock_fence, :integer)
    ...
    field(:generation_precondition, :map)
