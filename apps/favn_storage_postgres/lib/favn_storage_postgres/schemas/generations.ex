...
defmodule FavnStoragePostgres.Schemas.RebuildOperation do
  ...
  schema "rebuild_operations" do
    ...
    field(:dispatcher_owner, :string)
    field(:dispatcher_fencing_token, :integer)
    field(:dispatcher_expires_at, :utc_datetime_usec)
...
defmodule FavnStoragePostgres.Schemas.RebuildWindow do
  ...
  schema "rebuild_windows" do
    ...
    field(:runtime_input_expectation, :map)
    field(:status, :string)
...
defmodule FavnStoragePostgres.Schemas.TargetOperationLock do
  ...
  schema "target_operation_locks" do
    ...
    field(:effect_state, :string, default: "not_started")
    field(:effect_task_id, :string)
    field(:effect_assignment_generation, :integer)
    field(:effect_started_at, :utc_datetime_usec)
    field(:effect_resolution, :map)
    field(:fencing_token, :integer)
