...
defmodule FavnStoragePostgres.Schemas.RunOwnership do
  ...
  schema "run_ownerships" do
    field(:workspace_id, :string, primary_key: true)
    field(:run_id, :string, primary_key: true)
    field(:recovery_disposition, :string, default: "automatic")
    field(:recovery_attempts, :integer, default: 0)
    field(:claim_purpose, :string, default: "execution")
    field(:next_recovery_at, :utc_datetime_usec)
    field(:attention_revision, :integer)
    field(:owner_id, :string)
    field(:fencing_token, :integer)
    field(:claim_command_id, :string)
    field(:last_renewal_id, :string)
    field(:last_renewed_at, :utc_datetime_usec)
    field(:diagnosis_reason, :string)
